...
public class SessionVerint {
	...
	public String toString() {
		return "[exception_reason: " + exception_reason +
			", call_id: " + call_id +
			", personal_id: " + personal_id +
			", string_extension: " + string_extension +
			", pbx_login_id: " + pbx_login_id +
			", dnis: " + dnis +
			", total_hold_time_in_seconds: " + total_hold_time_in_seconds +
			", switch_id: " + switch_id +
			", ani: " + ani +
			", direction: " + direction +
			", switch_call_id: " + switch_call_id +
			", cd17: " + cd17 +
			", cd2: " + cd2 +
			", audio_end_time: " + audio_end_time +
			", media_type_bit_mask: " + media_type_bit_mask +
			", AUDIO_START_TIME: " + AUDIO_START_TIME +
			", wrapup_time_in_seconds: " + wrapup_time_in_seconds +
			", audio_module_num: " + audio_module_num +
